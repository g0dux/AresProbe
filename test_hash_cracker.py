#!/usr/bin/env python3
"""
Test script for Advanced Hash Cracker
"""
...
from aresprobe.core.advanced_hash_cracker import AdvancedHashCracker, HashAlgorithm
...
def test_hash_cracker():
    ...
    print(f"[+] Wordlists: {cracker.get_wordlists()}")
